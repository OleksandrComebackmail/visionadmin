...
const ComingBusinessEditActions = () => {
...
export const ComingBusinessEdit = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await dataProvider.getOne("coming-business", {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      await dataProvider.update("coming-business", {
        id: "coming-business-page-id",
        data: {
          title: values.title,
      ...
      notify("Coming Business saved successfully", { type: "success" });
      ...
      <Box sx={{ padding: "16px" }}>
        ...
        >
          <Typography variant="h5" sx={{ fontWeight: 600 }}>
            Edit Coming Business
          </Typography>
          <ComingBusinessEditActions />
        </Box>
